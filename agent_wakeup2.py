...
class ChatAgent:
    ...
    def system_prompt(self, scene: str, name_map: Dict[str, str]) -> str:
        ...
        return (
            ...
            f"Participants (you should remember their names):\n{roster}\n"
            f"- U: user\n\n"
...
def main():
    ...
    # This is what each agent sees as the roster mapping
    ...
    def log_chat(character: str, txt: str):
        ...
        # IMPORTANT: keep "Speaker: text" so models can attribute speakers.
    ...
    with open(chat_path, "a", encoding="utf-8") as chat_fp, open(thinking_path, "a", encoding="utf-8") as thinking_fp:
        ...
        def agent_turn(agent: ChatAgent, force_intro: bool = False):
            ...
            # Make speaker attribution explicit for the model.
            user_prompt = (
