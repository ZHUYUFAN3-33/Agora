...
Web version (readable on a phone, prints to PDF): <https://claude.ai/code/artifact/61ee2f65-95eb-41de-8178-18b4c58dd2d0>
中文版: [USER_GUIDE.zh.md](USER_GUIDE.zh.md)
...
- ① Only from the second session on: what has changed since last time. You can skip it
...
- ② The gear: summary, export and the rest live in this menu
...
- ② `Export log`: downloads this session as a zip
