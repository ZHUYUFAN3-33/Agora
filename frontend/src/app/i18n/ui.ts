...
const en: Dict = {
  ...
  "map.key.rows": "One row per voice — the AI advisors, and you",
  ...
  "map.key.line": "a line means someone replied to someone",
  "map.key.red": "red = disagreed",
  ...
  "map.noteKind.layer": "highlighted",
  "map.noteKind.system": "auto",
  ...
  "map.promoteLayers": "Add the parts you highlighted",
...
const zh: Dict = {
  ...
  "map.key.rows": "每行是一个声音——AI 顾问们，和你",
  ...
  "map.key.time": "从左到右是发言顺序",
  "map.key.line": "连线表示谁回应了谁",
  "map.key.red": "红色表示不同意",
  ...
  "map.noteKind.layer": "标记",
  "map.noteKind.system": "自动",
  "map.lane.focus": "主要支持",
  "map.lane.worry": "主要担心",
  "map.view.ledger": "选项",
  "map.view.river": "讨论经过",
