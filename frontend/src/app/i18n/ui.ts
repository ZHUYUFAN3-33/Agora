...
const en: Dict = {
  ...
  "welcome.sceneUnavailable": "not in this study",
  ...
  "chat.modeLocked": "assigned for this study",
  ...
  "err.noResponse": "No one managed to reply this time. Please send your message again.",
  ...
  // Phase
  "phase.Exploration": "Laying out the situation",
  "phase.Structuring": "Sorting the options",
  "phase.Narrowing": "Ruling things out",
  "phase.Convergence": "Closing in",
  ...
  "map.splitView": "Side by side with the chat",
  "map.expand": "Expand to full width",
  "map.refresh": "Refresh",
  "map.loading": "Loading…",
  "map.extract": "Look closer",
  "map.extracting": "Reading…",
  "map.extractHint": "Re-read the conversation to find more of what was said for and against each option",
  "map.phases": "Phases",
  "map.replyGraph": "Who answered whom",
  "map.replyGraphCount": "{turns} turns · {relations} replies",
  "map.replyGraphOpposes": "{n} pushed back",
  "chat.willReply": "Will reply:",
  "chat.willReplyAuto": "pick an agent, or leave it to the room",
  // Map key — the whole legend a first-time reader needs, in plain words.
  "map.key.rows": "each row = one voice (the advisors, and you)",
  "map.ledgerHint": "Click any line to see where it was said",
  "map.strength.clear": "Clear",
  "map.strength.leaning": "Leaning",
  "map.strength.undecided": "Undecided",
  "map.subtitleLedger": "What each option had going for and against it",
  "map.key.time": "left to right = order of speaking",
  "map.key.line": "= replied to",
  "map.key.red": "= disagreed",
  // Edge labels in plain language, never jargon.
  "map.edge.challenge": "disagreed",
  "map.edge.extend": "built on",
  "map.edge.clarify": "answered",
  "map.edge.mention": "mentioned",
  "map.edge.answers": "replied",
  "map.tooltip.repliedTo": "replying to:",
  "map.lane.focus": "mostly argues for",
  "map.lane.worry": "mostly worried about",
  "map.view.ledger": "Options",
  "map.view.river": "How it unfolded",
  "map.ledger.for": "Said for it",
  "map.ledger.against": "Said against it",
  "map.ledger.none": "nothing said",
  "map.ledger.nothingSaid": "This option was never discussed.",
  "map.ledger.raisedBy": "raised by",
  "map.ledger.alsoBacked": "also backed by",
  "map.ledger.fromIntake": "From what you told us at the start",
  "map.ledger.headlineChosen": "Where this landed:",
  "map.ledger.headlineOpen": "No choice made yet — here is what was said about each option.",
  "map.guidance.against": "Left unanswered",
  "map.guidance.would_change": "What would change this",
  "map.guidance.your_call": "Only you can decide",
  "map.replyGraphUser": "You",
  "map.verdict.chosen": "Decision",
  "map.verdict.why": "Because",
  "map.verdict.leaning": "Leaning",
  "map.verdict.undecided": "Not decided yet",
  "map.milestone.choice": "Chose",
  "map.milestone.optionsShown": "Options shown",
  "map.param.turn": "Turn",
  "map.param.move": "Move",
  "map.param.rationale": "Rationale",
  "map.param.stance": "Stance",
  "map.turn.softened": "Later walked this back",
  "map.topics": "Topics",
  "map.stances": "Stances",
  ...
  "map.issues": "Issues",
  "map.claims": "Claims",
  "map.subtitleSmart": "How the discussion reached its decision",
...
const zh: Dict = {
  ...
  "welcome.sceneUnavailable": "本次研究不开放",
  ...
  "err.noResponse": "这一轮没有生成回复，请再发送一次。",
  "chat.thinking": "思考中",
  "err.export": "导出失败",
  ...
  "phase.Exploration": "摊开情况",
  "phase.Structuring": "整理选项",
  "phase.Narrowing": "排除一些",
  "phase.Convergence": "接近决定",
  "phase.Concluded": "已结束",
  ...
  "map.extract": "更仔细地分析",
  "map.extracting": "正在阅读…",
  "map.extractHint": "重新读一遍对话，补出更多支持和反对各选项的说法",
  "map.phases": "阶段",
  "map.replyGraph": "谁回应了谁",
  "map.replyGraphCount": "{turns} 轮发言 · {relations} 条回应",
  "map.replyGraphOpposes": "{n} 次反驳",
  "chat.willReply": "将回复：",
  "chat.willReplyAuto": "选一位，或交给全场自行接话",
  "map.key.rows": "每行 = 一个声音（AI 顾问们，和你）",
  "map.ledgerHint": "点任意一条，看它是在哪里说的",
  "map.strength.clear": "明确",
  "map.strength.leaning": "倾向",
  "map.strength.undecided": "未定",
  "map.subtitleLedger": "每个选项各自的利弊",
  "map.key.time": "从左到右 = 发言顺序",
  "map.key.line": "= 回应",
  "map.key.red": "= 不同意",
  "map.edge.challenge": "不同意",
  "map.edge.extend": "补充",
  "map.edge.clarify": "解答",
  "map.edge.mention": "提到",
  "map.edge.answers": "回应",
  "map.tooltip.repliedTo": "回应的是：",
  "map.lane.focus": "主要支持",
  "map.lane.worry": "主要担心",
  "map.view.ledger": "选项",
  "map.view.river": "讨论经过",
  "map.ledger.for": "支持它的说法",
  "map.ledger.against": "反对它的说法",
  "map.ledger.none": "没人说过",
  "map.ledger.nothingSaid": "这个选项没有被讨论过。",
  "map.ledger.raisedBy": "由谁提出：",
  "map.ledger.alsoBacked": "也支持：",
  "map.ledger.fromIntake": "来自你一开始说的情况",
  "map.ledger.headlineChosen": "最后落在：",
  "map.ledger.headlineOpen": "还没做出选择——以下是每个选项各自被说了什么。",
  "map.guidance.against": "没有被正面回应的理由",
  "map.guidance.would_change": "什么情况会推翻这个结论",
  "map.guidance.your_call": "只能由你决定的问题",
  "map.replyGraphUser": "你",
  "map.verdict.chosen": "最终选择",
  "map.verdict.why": "关键理由",
  "map.verdict.leaning": "当前倾向",
  "map.verdict.undecided": "尚未做出选择",
  "map.milestone.choice": "选定",
  "map.milestone.optionsShown": "展示了选项",
  "map.param.turn": "发言",
  "map.param.move": "行为",
  "map.param.rationale": "理由",
  "map.param.stance": "立场",
  "map.turn.softened": "后来有所松口",
  "map.topics": "话题",
  "map.stances": "立场",
  "map.conclusion": "结论",
...
/**
 * The reader's own name inside the decision map.
 *
 * Callers must pass the raw account id (or nothing), NOT Chat's `nickname` —
 * that constant already bakes in the English literal "You", which would print
 * untranslated in a Chinese map and make this fallback dead code.
 */
export function userLabel(lang: UiLang, name?: string | null): string {
  const n = (name || "").trim();
  return n || t(lang, "map.replyGraphUser");
}
